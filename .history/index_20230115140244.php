...
<body>
    <div class="bot-windows">
        <div class="bot-window-materail">
            <div class="profile d-flex bd-highlight mb-3">
                ...
                <div class="profile-name p-2 bd-highlight align-self-center">
                    Jack
                </div>
            ...
            <div class="chat-screen  d-flex align-items-start flex-column bd-highlight mb-3">
                    



                <div id="body mb-auto p-2 bd-highlight d-flex">
                ...
                <div class="bottom-tools p-2 bd-highlight">
                    <div class="input-group rounded p-2 bd-highlight">
                        <button type="button" class="btn btn-default " aria-label="Left Align">
                        ...
                        <input type="search" id="userInput" class="send-box mr-auto p-2" placeholder="" aria-label="Search" aria-describedby="search-addon"  name="messages"/>
                    </div>
                    <button type="button" class="camera  p-2 bd-highlight" aria-label="Left Align">
                        <span class="glyphicon glyphicon-camera" style="color:black" aria-hidden="true"></span>
                    </button>
                    <button id="send" class="send-button send ml-auto p-2 bd-highlight" aria-label="Left Align">
