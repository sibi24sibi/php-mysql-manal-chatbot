    ...
    <div class="bot-windows">
        <div class="bot-window-materail">
            ...
            <div class="profile d-flex">
             ...
             <div class="flex-container  chat-screen ">
                ...
                <div class="bottom-tools d-flex flex-items">
                        ...
                        <input type="text" id="userInput" class="send-box mr-auto p-2 align-self-center" placeholder="" aria-label="Search" aria-describedby="search-addon"  name="messages"/>
